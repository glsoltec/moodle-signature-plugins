...
class provider implements
    ...
    public static function get_users_in_context(userlist $userlist): void {
        ...
        global $DB;
        if ($DB->record_exists('local_certificatesign_audit', ['userid' => $userid])) {
            $userlist->add_user($userid);
        }
    }

    /**
     * Export all user data for the specified user in the approved contexts.
     *
     ...
     *
     * Audit records are anonymized (userid=0, ipaddress and useragent cleared)
     * rather than deleted to preserve the audit trail integrity.
     *
     * @param approved_contextlist $contextlist
     * @return void
     */
    ...
    /**
     * Delete all user data for the specified users in the approved context.
     *
